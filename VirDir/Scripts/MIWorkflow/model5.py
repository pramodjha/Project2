...
class Acceptrejectdetail(models.Model):
    ...
    estacceptrejectoption = models.ForeignKey('Acceptrejectoption', models.DO_NOTHING, db_column='estacceptrejectoption', blank=True, null=True)
    requeststatus = models.ForeignKey('Statusdetail', models.DO_NOTHING, db_column='requeststatus', blank=True, null=True)
